# 05 — Constrained machine-lever reuse

**What to build:** Reuse the complete motion-understanding engine for fixed machines whose useful equipment evidence is a constrained moving handle or lever rather than a cable endpoint or a free rigid bar.
