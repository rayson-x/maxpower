...
- Current Rust implementation produces canonical set/Rep state, three endpoint snapshots, joint-angle and equipment evidence, plus QLT1 quality proposals. Fresh release `personal-motion-quality-review-v1` (`sha256:caf6294fd87098ca12712597c5ac15ee8f836abbf81eed232a81d9487d567c37`) passed the Audit A launch gates and is open for human calibration. The review evidence separately preserves raw Halpe-26 input pose and ordered oblique shaft endpoints, so an `equipment_only` Rust phase policy cannot hide the available input skeleton or flatten the visual shaft overlay. This implementation and review readiness are not accuracy evidence. The accepted Web harness now projects Rust QLT1 directly; legacy TypeScript five-layer reporting is outside the accepted chain and must not become a second authority.
