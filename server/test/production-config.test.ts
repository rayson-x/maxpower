...
function validEnvironment(overrides: NodeJS.ProcessEnv = {}): NodeJS.ProcessEnv {
  return {
    ...
    HTTP_MAX_REQUEST_BYTES: "16777216",
    ...
    LLM_COACH_MAX_INPUT_BYTES: "10485760",
    LLM_COACH_MAX_INPUT_TOKENS: "131072",
    LLM_COACH_MAX_OUTPUT_TOKENS: "4096",
    LLM_COACH_MAX_IMAGES: "0",
    LLM_COACH_MAX_IMAGE_BYTES: "1024",
    LLM_NUTRITION_PROVIDER_ENDPOINT: "https://nutrition-provider.example/v1/chat/completions",
    LLM_NUTRITION_PROVIDER_API_KEY: "nutrition-provider-secret",
    LLM_NUTRITION_PROVIDER_ID: "nutrition-provider",
    LLM_NUTRITION_MODEL: "nutrition-model",
    LLM_NUTRITION_INPUT_CREDITS_PER_MILLION: "0",
    LLM_NUTRITION_OUTPUT_CREDITS_PER_MILLION: "0",
    LLM_NUTRITION_PRICING_VERSION_ID: "nutrition-pricing-v1",
    LLM_NUTRITION_MAX_INPUT_BYTES: "524288",
    LLM_NUTRITION_MAX_INPUT_TOKENS: "8388608",
    LLM_NUTRITION_MAX_OUTPUT_TOKENS: "2048",
    LLM_NUTRITION_MAX_IMAGES: "4",
    LLM_NUTRITION_MAX_IMAGE_BYTES: "524288",
    LLM_NUTRITION_PROVIDER_INPUT_COST_MICROS_PER_MILLION: "0",
    LLM_NUTRITION_PROVIDER_OUTPUT_COST_MICROS_PER_MILLION: "0",
