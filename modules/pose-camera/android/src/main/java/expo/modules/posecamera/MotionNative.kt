...
internal object MotionNative {
   ...
   * [x, y, width, height, torsoR, torsoG, torsoB]. Equipment metadata is
   * [kind, x, y, width, height, score, uncertaintyPx, source, flags]. A
   * negative uncertainty means unknown. Rust owns subject/equipment identity.
   */
