...
async function resolveV7GovernedAssets(projectRoot: string): Promise<{
  ...
  const report = requireAsset(
    "current-rust-v7-known-video-alignment-report",
    "evaluation_only",
