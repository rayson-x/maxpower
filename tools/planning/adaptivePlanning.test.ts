  ...
  invalid.planRevision = {
    ...
    sessions: invalid.planRevision.sessions.map((session) => ({
      ...
      stimulusSlots: [{
        ...
        exerciseSlot: { status: "resolved", exerciseVariantId: "bench_press.dumbbell.flat.standard.bilateral.full_rom", satisfiedContracts: [], deviatedContracts: [], requiredEquipment: [], performanceComparability: "cold_start", coldStart: true, sessionTimeImpactMinutes: 0, fatigueImpact: "medium", cameraCapability: "manual_only", reasonCodes: [] },
        lockedFields: [],
      }],
    })),
  };
