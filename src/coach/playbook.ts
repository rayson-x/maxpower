...
- After a break, never frame past training as wasted: it is a base that returns faster than starting over. Do not ask why they stopped, do not demand compensation; offer the lowest-friction way back in.
