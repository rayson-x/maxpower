...
function readablePlanSessionTitle(title: string | undefined | null): string { return (title ?? "训练").replace("hypertrophy", mobileT("mobile.ui.productshell.5ea5b92ec0")).replace("strength", mobileT("mobile.ui.productshell.043b41ab7d")).replace("fat_loss_preserve_lean_mass", mobileT("mobile.ui.productshell.18c4940da9")); }
