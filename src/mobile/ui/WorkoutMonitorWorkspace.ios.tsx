...
export function WorkoutMonitorWorkspace(props: WorkoutMonitorWorkspaceProps) {
  ...
  return <LiveScreen config={config} setContext={props.setContext} coachStream={props.coachStream} onSendToCoach={props.onSendToCoach} onCoachCardAction={props.onCoachCardAction} onCoachHumanAction={props.onCoachHumanAction} onExit={() => void exit()} onPermissionDenied={permissionDenied} onSafetyPause={safetyPause} onSetObservationReady={(observation) => void finishObservation(observation)} onOpenSavedVideo={openSavedVideo} locale={props.locale} />;
}
