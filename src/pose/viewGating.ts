...
const CAPTURE_RECOMMENDATIONS: Readonly<Record<string, CaptureRecommendation>> = {
  ...
  jumping_jack: { position: "front", reason: "正前方可同时观察双脚跳开、并拢与双臂开合。" },
  sit_up: { position: "left", reason: "侧面最利于观察躯干从仰卧到起身再返回的周期。" },
  ...
  standing_dumbbell_row: { position: "frontLeft45", reason: "斜前 45° 可同时保留双肘拉动与俯身躯干。" },
  ...
  lat_pulldown: { position: "rear", reason: "正后方匹配当前高位下拉轨迹 profile，并保留双臂与躯干对称。" },
  wide_grip_lat_pulldown: { position: "rear", reason: "正后方可保留宽握双手、双肘与躯干对称。" },
  ...
  alternating_lunge: { position: "frontLeft45", reason: "斜前 45° 可分辨原地交替前腿与上下行程。" },
  ...
  alternating_dumbbell_biceps_curl: { position: "frontLeft45", reason: "斜前 45° 可观察左右臂交替屈伸，并保留近侧完整肘角。" },
  ...
  decline_barbell_bench_press: { position: "frontLeft45", reason: "斜前 45° 可同时保留下斜凳、双肘与杠铃路径。" },
  chest_dip: { position: "left", reason: "侧面最利于观察前倾胸部版双杠臂屈伸的下放与撑起。" },
  pec_deck_fly: { position: "front", reason: "正前方可观察固定器械中的双臂合拢与对称性。" },
  chin_up: { position: "front", reason: "正前方可观察反握双手、双肘与身体整体上移。" },
  t_bar_row: { position: "frontLeft45", reason: "斜前 45° 可兼顾握把、双肘和胸托或躯干支撑。" },
  back_extension: { position: "left", reason: "侧面最利于观察髋铰链与躯干回到中立的相位。" },
  front_squat: { position: "frontLeft45", reason: "斜前 45° 可兼顾前架杠位、膝轨迹与躯干。" },
  goblet_squat: { position: "frontLeft45", reason: "斜前 45° 可同时观察持重位置、膝轨迹与躯干。" },
  seated_leg_curl: { position: "left", reason: "侧面可清楚记录坐姿机器的膝屈曲行程。" },
  lying_leg_curl: { position: "left", reason: "侧面可清楚记录俯卧机器的膝屈曲行程。" },
  glute_bridge: { position: "left", reason: "侧面最利于区分地面臀桥的髋部上下行程。" },
  dumbbell_shoulder_press: { position: "frontLeft45", reason: "斜前 45° 可保留双哑铃、双肘与靠背位置。" },
  arnold_press: { position: "frontLeft45", reason: "斜前 45° 可观察推举行程，并把旋转过程保留为弱证据。" },
  upright_row: { position: "front", reason: "正前方可观察握距、双肘外展和双腕上移。" },
  preacher_curl: { position: "frontLeft45", reason: "斜前 45° 可观察上臂垫支撑与肘部屈伸。" },
  incline_dumbbell_curl: { position: "frontLeft45", reason: "斜前 45° 可同时保留凳角、双臂和肘部行程。" },
  close_grip_bench_press: { position: "frontLeft45", reason: "斜前 45° 可同时观察窄握、双肘与杠铃路径。" },
};
