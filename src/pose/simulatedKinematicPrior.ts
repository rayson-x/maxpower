...
export const SIMULATED_KINEMATIC_PRIOR_SCHEMA =
  "maxpower-simulated-kinematic-prior/v1" as const;
...
export interface SimulatedKinematicPriorTemplate {
  ...
  /** Optional counter state graph; it never changes calibration or form semantics. */
  readonly initializerStateMachineId?:
...
export interface FiveSplitPriorWorkflow {
  readonly schemaVersion: "maxpower-five-split-prior-workflow/v1";
  readonly source: "simulated_kinematic_prior";
...
const TEMPLATES: readonly SimulatedKinematicPriorTemplate[] = [
  ...
  template({ exerciseId: "conventional_deadlift", muscleGroup: "legs", primaryCapturePosition: "left", supportedCapturePositions: ["right", "frontLeft45"], phaseLabels: { start: "地面起始", extreme: "髋膝伸展顶部", end: "受控回到地面" }, toExtremeMeaning: "floor_to_lockout", fromExtremeMeaning: "controlled_lowering", features: [primary("hipAngleDeg", "increase_to_extreme", "离地到站直时髋部投影角总体趋向伸展。"), primary("kneeAngleDeg", "increase_to_extreme", "离地阶段膝部投影角总体趋向伸展，作为与 RDL 区分的相位证据。"), secondary("torsoLeanImageDeg", "decrease_to_extreme", "固定侧面中躯干相对竖直的倾角总体减小，只作同 identity 的辅助特征。")], assumptions: ["传统硬拉与 RDL 不共享轨迹、时序或数值；起始高度、杠铃规格、站距和握法必须记录。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  ...
  template({ exerciseId: "alternating_dumbbell_biceps_curl", muscleGroup: "arms", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "front"], initializerStateMachineId: "alternating-ready-effort-return/v1", phaseLabels: { start: "一侧肘部伸展", extreme: "该侧弯举顶部", end: "该侧回到伸展" }, toExtremeMeaning: "alternating_elbow_flexion", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "decrease_to_extreme", "交替状态机在每次激活时锁定当前运动侧肘角。"), secondary("wristHeightRelativeShoulderY", "decrease_to_extreme", "手腕上移只作辅助相位。")], assumptions: ["左右臂分别构成 rep；状态机在一次 rep 内锁定同一侧，返回后才允许另一侧开始。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  ...
  // Reviewed common-exercise expansion. These remain uncalibrated catalog
  // priors and must never be interpreted as standards or form scores.
  template({ exerciseId: "decline_barbell_bench_press", muscleGroup: "chest", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "left"], phaseLabels: { start: "底部", extreme: "推起顶部", end: "回到底部" }, toExtremeMeaning: "press", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "increase_to_extreme", "推起时肘部投影角总体趋向伸展。"), secondary("wristDistanceToShoulder", "increase_to_extreme", "杠铃相对肩部远离只作辅助。")], assumptions: ["下斜角度、握距、杠铃路径和机位必须单独校准。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "chest_dip", muscleGroup: "chest", primaryCapturePosition: "left", supportedCapturePositions: ["right", "frontLeft45"], phaseLabels: { start: "下放底部", extreme: "撑起顶部", end: "回到底部" }, toExtremeMeaning: "press", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "increase_to_extreme", "撑起时肘部投影角总体趋向伸展。"), secondary("wristDistanceToShoulder", "increase_to_extreme", "肩部相对固定手部上移只作辅助。")], assumptions: ["胸部版前倾、双杠宽度和辅助方式属于 identity。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "pec_deck_fly", muscleGroup: "chest", primaryCapturePosition: "front", supportedCapturePositions: ["frontLeft45", "frontRight45"], phaseLabels: { start: "张开", extreme: "合拢", end: "回到张开" }, toExtremeMeaning: "adduction", fromExtremeMeaning: "controlled_return", features: [primary("wristLateralSpread", "decrease_to_extreme", "固定正面机位中双腕横向间距在合拢时总体缩小。"), secondary("elbowAngleDeg", "hold", "肘部角度仅作同器械辅助观察。")], assumptions: ["座椅高度、握把/肘垫形式和机器连杆路径必须固定。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "chin_up", muscleGroup: "back", primaryCapturePosition: "front", supportedCapturePositions: ["frontLeft45", "frontRight45"], phaseLabels: { start: "反握悬垂", extreme: "身体上移顶点", end: "回到悬垂" }, toExtremeMeaning: "pull", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "decrease_to_extreme", "上拉时肘部投影角总体趋向屈曲。"), secondary("wristDistanceToShoulder", "decrease_to_extreme", "肩部接近固定手部只作辅助。")], assumptions: ["反握握距、是否辅助和摆动方式不能混入正手引体 profile。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "t_bar_row", muscleGroup: "back", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "left"], phaseLabels: { start: "手臂伸展", extreme: "拉至躯干", end: "回到伸展" }, toExtremeMeaning: "pull", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "decrease_to_extreme", "拉动时肘部投影角总体趋向屈曲。"), secondary("wristDistanceToShoulder", "decrease_to_extreme", "握把靠近躯干只作辅助。")], assumptions: ["胸托与否、把手宽度、地雷管或机器结构必须分桶。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "back_extension", muscleGroup: "back", primaryCapturePosition: "left", supportedCapturePositions: ["right", "frontLeft45"], phaseLabels: { start: "髋屈曲底部", extreme: "躯干回到中立", end: "回到底部" }, toExtremeMeaning: "hip_extension", fromExtremeMeaning: "controlled_return", features: [primary("hipAngleDeg", "increase_to_extreme", "起身时髋部投影角总体趋向伸展。"), secondary("torsoLeanImageDeg", "decrease_to_extreme", "固定侧面中躯干相对竖直倾角总体减小。")], assumptions: ["45 度罗马椅；髋主导与脊柱主导策略不能混为同一标准。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "front_squat", muscleGroup: "legs", primaryCapturePosition: "left", supportedCapturePositions: ["right", "frontLeft45"], phaseLabels: { start: "站立顶部", extreme: "下蹲底部", end: "站回顶部" }, toExtremeMeaning: "eccentric", fromExtremeMeaning: "concentric", features: [primary("kneeAngleDeg", "decrease_to_extreme", "下蹲时膝部投影角总体趋向屈曲。"), primary("hipHeightRelativeAnkleY", "increase_to_extreme", "髋部相对脚踝总体下移。"), secondary("hipAngleDeg", "decrease_to_extreme", "髋部投影角只作辅助。")], assumptions: ["前架方式、鞋跟、站距和杠位必须固定。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "goblet_squat", muscleGroup: "legs", primaryCapturePosition: "left", supportedCapturePositions: ["right", "frontLeft45"], phaseLabels: { start: "站立顶部", extreme: "下蹲底部", end: "站回顶部" }, toExtremeMeaning: "eccentric", fromExtremeMeaning: "concentric", features: [primary("kneeAngleDeg", "decrease_to_extreme", "下蹲时膝部投影角总体趋向屈曲。"), primary("hipHeightRelativeAnkleY", "increase_to_extreme", "髋部相对脚踝总体下移。")], assumptions: ["哑铃/壶铃、持重高度、站距和机位必须固定。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "seated_leg_curl", muscleGroup: "legs", primaryCapturePosition: "left", supportedCapturePositions: ["right", "frontLeft45"], phaseLabels: { start: "伸膝起点", extreme: "坐姿屈膝终点", end: "回到伸膝" }, toExtremeMeaning: "knee_flexion", fromExtremeMeaning: "controlled_return", features: [primary("kneeAngleDeg", "decrease_to_extreme", "屈膝时膝部投影角总体趋向屈曲。")], assumptions: ["坐姿机器、靠背角、压腿垫和滚筒位置属于 identity。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "lying_leg_curl", muscleGroup: "legs", primaryCapturePosition: "left", supportedCapturePositions: ["right", "frontLeft45"], phaseLabels: { start: "伸膝起点", extreme: "俯卧屈膝终点", end: "回到伸膝" }, toExtremeMeaning: "knee_flexion", fromExtremeMeaning: "controlled_return", features: [primary("kneeAngleDeg", "decrease_to_extreme", "屈膝时膝部投影角总体趋向屈曲。")], assumptions: ["俯卧机器、髋垫和滚筒位置属于 identity，不能借用坐姿 profile。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "glute_bridge", muscleGroup: "legs", primaryCapturePosition: "left", supportedCapturePositions: ["right", "frontLeft45"], phaseLabels: { start: "地面髋屈曲底部", extreme: "臀桥顶部", end: "回到底部" }, toExtremeMeaning: "hip_extension", fromExtremeMeaning: "controlled_return", features: [primary("hipAngleDeg", "increase_to_extreme", "顶髋时髋部投影角总体趋向伸展。"), primary("hipHeightRelativeAnkleY", "decrease_to_extreme", "固定侧面中髋部相对脚踝总体上移。")], assumptions: ["肩背在地面、足距和是否负重必须固定；不可借用背靠长凳的臀推数值。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "dumbbell_shoulder_press", muscleGroup: "shoulders", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "front"], phaseLabels: { start: "哑铃肩侧底部", extreme: "过顶顶部", end: "回到底部" }, toExtremeMeaning: "press", fromExtremeMeaning: "controlled_return", features: [primary("wristHeightRelativeShoulderY", "decrease_to_extreme", "上推时双腕总体上移。"), primary("elbowAngleDeg", "increase_to_extreme", "上推时肘部投影角总体趋向伸展。")], assumptions: ["双哑铃、坐姿、靠背角和握法必须固定。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "arnold_press", muscleGroup: "shoulders", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "front"], phaseLabels: { start: "掌心向内底部", extreme: "旋转推举顶部", end: "回到底部" }, toExtremeMeaning: "press", fromExtremeMeaning: "controlled_return", features: [primary("wristHeightRelativeShoulderY", "decrease_to_extreme", "推举时双腕总体上移。"), primary("elbowAngleDeg", "increase_to_extreme", "推举时肘部投影角总体趋向伸展。"), secondary("wristLateralSpread", "increase_to_extreme", "双腕展开只作旋转过程的弱代理。")], assumptions: ["普通二维骨架不能可靠测量前臂旋转；凳角和旋转路径必须固定。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "upright_row", muscleGroup: "shoulders", primaryCapturePosition: "front", supportedCapturePositions: ["frontLeft45", "frontRight45"], phaseLabels: { start: "手臂下垂", extreme: "直立提拉顶部", end: "回到下方" }, toExtremeMeaning: "raise", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "decrease_to_extreme", "提拉时肘部投影角总体趋向屈曲。"), primary("wristHeightRelativeShoulderY", "decrease_to_extreme", "提拉时双腕总体上移。"), secondary("wristLateralSpread", "hold", "握距只作同 identity 辅助。")], assumptions: ["杠铃/绳索、握距和提拉高度分别校准，不设置肩部安全阈值。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "preacher_curl", muscleGroup: "arms", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "left"], phaseLabels: { start: "肘部伸展", extreme: "牧师凳弯举顶部", end: "回到伸展" }, toExtremeMeaning: "elbow_flexion", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "decrease_to_extreme", "弯举时肘部投影角总体趋向屈曲。"), secondary("wristDistanceToShoulder", "decrease_to_extreme", "器械靠近肩部只作辅助。")], assumptions: ["EZ 杠/哑铃、座椅和上臂垫角度必须固定。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "incline_dumbbell_curl", muscleGroup: "arms", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "left"], phaseLabels: { start: "肘部伸展", extreme: "上斜弯举顶部", end: "回到伸展" }, toExtremeMeaning: "elbow_flexion", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "decrease_to_extreme", "弯举时肘部投影角总体趋向屈曲。"), secondary("wristHeightRelativeShoulderY", "decrease_to_extreme", "手腕上移只作辅助。")], assumptions: ["凳角、交替/同时和前臂旋转必须固定。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "close_grip_bench_press", muscleGroup: "arms", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "left"], phaseLabels: { start: "底部", extreme: "窄握推起顶部", end: "回到底部" }, toExtremeMeaning: "press", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "increase_to_extreme", "推起时肘部投影角总体趋向伸展。"), secondary("wristDistanceToShoulder", "increase_to_extreme", "杠铃相对肩部远离只作辅助。")], assumptions: ["窄握距离、凳面、杠铃路径和机位必须固定，不能借用普通卧推数值。"], prohibitedClaims: COMMON_PROHIBITIONS }),

  // External-dataset action identities. These are deliberately broad
  // recognition initializers; MM-Fit/RepCount evidence must not turn them into
  // form standards or production-calibrated profiles.
  template({ exerciseId: "jumping_jack", muscleGroup: "legs", primaryCapturePosition: "front", supportedCapturePositions: ["frontLeft45", "frontRight45"], phaseLabels: { start: "双脚并拢且手臂下垂", extreme: "双脚跳开且双臂展开", end: "跳回并拢" }, toExtremeMeaning: "coordinated_open", fromExtremeMeaning: "coordinated_close", features: [primary("ankleLateralSpread", "increase_to_extreme", "正面机位中双踝横向间距在跳开时增大。"), primary("wristLateralSpread", "increase_to_extreme", "双臂同步展开时双腕横向间距增大。")], assumptions: ["这是双脚同时跳开的标准开合跳，不能借用低冲击 step jack 的单侧迈步 profile。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "alternating_lunge", muscleGroup: "legs", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "left", "right"], phaseLabels: { start: "原地站立顶部", extreme: "前腿下降底部", end: "回到原地站立" }, toExtremeMeaning: "lowering", fromExtremeMeaning: "rising", features: [primary("kneeAngleDeg", "decrease_to_extreme", "工作侧膝角在下降时总体趋向屈曲。"), primary("hipHeightRelativeAnkleY", "increase_to_extreme", "骨盆相对脚踝总体下移。")], assumptions: ["左右步次交替但回到原地；不能与持续向前位移的 walking lunge 共用 identity。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "standing_dumbbell_row", muscleGroup: "back", primaryCapturePosition: "frontLeft45", supportedCapturePositions: ["frontRight45", "left", "right"], phaseLabels: { start: "双臂伸展", extreme: "双哑铃拉近躯干", end: "回到伸展" }, toExtremeMeaning: "pull", fromExtremeMeaning: "controlled_return", features: [primary("elbowAngleDeg", "decrease_to_extreme", "双肘在拉动时总体趋向屈曲。"), secondary("wristDistanceToShoulder", "decrease_to_extreme", "双腕靠近躯干只作辅助相位证据。")], assumptions: ["站姿俯身双哑铃；不能借用单臂长凳支撑划船 profile。"], prohibitedClaims: COMMON_PROHIBITIONS }),
  template({ exerciseId: "sit_up", muscleGroup: "core", primaryCapturePosition: "left", supportedCapturePositions: ["right", "frontLeft45"], phaseLabels: { start: "仰卧起点", extreme: "躯干起身顶点", end: "受控回到仰卧" }, toExtremeMeaning: "trunk_flexion", fromExtremeMeaning: "controlled_return", features: [primary("hipAngleDeg", "decrease_to_extreme", "侧面机位中肩-髋-膝投影角在起身时总体减小。"), secondary("torsoLeanImageDeg", "increase_to_extreme", "躯干相对图像竖直方向变化只作辅助。")], assumptions: ["仰卧起坐、卷腹和屈髋起身必须分开；普通二维骨架不用于判断腰椎负荷。"], prohibitedClaims: COMMON_PROHIBITIONS }),
];
