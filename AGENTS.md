...
**措辞纪律**：app 界面与 agent 上下文（playbook/passages/话术）禁用医学措辞——「诊断」「处方」「疗程」「医嘱」等一律不用；用「了解情况 / 分析 / 判断 / 方案 / 建议」。
...
Monorepo（单 git 仓，remote: `git@github.com:rayson-x/maxpower.git`，public（2026-08-17 作者确认））：
