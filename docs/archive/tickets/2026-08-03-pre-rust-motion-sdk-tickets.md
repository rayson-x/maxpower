# Archived Tickets: Pre-Rust Motion Recognition SDK

_状态：superseded。归档日期：2026-08-03。替代规格：[`Rust Motion Recognition SDK V1`](../../../../strength-cut-coach/docs/specs/2026-08-03-rust-motion-recognition-sdk-spec.md)。_

本文件完整保留清理前的完成记录与未完成任务，仅供历史追溯。未完成复选框不再代表可领取工作；不得直接继续实施，必须由当前 active spec 重新拆票。

归档时关联的历史 specs：

- Canonical 移动端骨架连续性 SDK：[`2026-08-02-canonical-mobile-pose-continuity-sdk-spec.md`](../../../../strength-cut-coach/docs/archive/specs/2026-08-02-canonical-mobile-pose-continuity-sdk-spec.md)
- 骨架运动轨迹 + 规则引擎：[`2026-08-02-skeleton-trajectory-rule-engine-v1-spec.md`](../../../../strength-cut-coach/docs/archive/specs/2026-08-02-skeleton-trajectory-rule-engine-v1-spec.md)
- Rust Motion Recognition SDK：[`2026-08-03-rust-motion-recognition-sdk-spec.md`](../../../../strength-cut-coach/docs/specs/2026-08-03-rust-motion-recognition-sdk-spec.md)

以下 frontier 说明是归档快照，不再有效。
